...
<p align="center">
  <strong>Software Architect</strong> — I design systems that don't fall apart.
</p>
...
**Primary**: Go · NixOS · Event Sourcing · CQRS · HTMX
**Also**: Kotlin · Rust · TypeScript · Python · Elixir
**Infrastructure**: Docker · Google Cloud · GitHub Actions

---

<p align="center">
  <em>You have a system that needs to work.<br/>I build systems that work.<br/>
